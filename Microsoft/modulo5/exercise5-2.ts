//Exercício 1 – Converter três funções do TypeScript em uma definição de classe
//https://docs.microsoft.com/pt-br/learn/modules/typescript-declare-instantiate-classes/12-functions-class-lab
